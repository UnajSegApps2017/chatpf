...
/**
 * FilemessageSearch represents the model behind the search form about `app\models\Filemessage`.
 */
class FilemessageSearch extends Filemessage
{
    /**
     * @inheritdoc
     */
